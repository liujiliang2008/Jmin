...
package org.jmin.jda.impl.config.dynamictext.html;
...
public class HTMLTokenizer {
    ...
    public HTMLTokenizer (InputStream is) throws IOException {
        tokens = new Vector();
        parseInputStream(is);
    }

    public HTMLTokenizer (Reader is) throws IOException {
        tokens = new Vector();
        parseInputStream(is);
    }
	...
	private void parseInputStream (InputStream is) throws IOException {
            parseInputStream(new InputStreamReader(is));
        }

	private void parseInputStream (Reader is) throws IOException {
